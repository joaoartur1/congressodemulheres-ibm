...
-- Corrige o horário do prazo de camisas: 12/08/2026 14:00, não 23:59.
...
declare
  ...
  v_prazo_camisas timestamptz := '2026-08-12 14:00:00-03'; -- manter sincronizado com PRAZO_CAMISAS
...
begin
  ...
  if jsonb_array_length(p_camisas) > 0 and now() > v_prazo_camisas then
    raise exception 'As vendas de camisa encerraram no dia 12/08 às 14h00';
  end if;
